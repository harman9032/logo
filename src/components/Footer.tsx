...
const SERVICES = [
  ...
  { label: 'Brand Guidelines', href: '/services/brand-identity' },
];
    ...
    <footer className="bg-gray-900 text-white py-16" aria-label="Site footer">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 pb-12 border-b border-gray-800">
          ...
          <div>
            <h3 className="text-sm font-bold text-white mb-5">Services</h3>
          ...
          <div>
            <h3 className="text-sm font-bold text-white mb-5">Contact</h3>
            <div className="space-y-3">
              ...
              >
                <Phone className="h-4 w-4 text-green-500 flex-shrink-0" aria-hidden="true" />
              ...
              <a
                ...
                className="flex items-center gap-3 text-gray-400 hover:text-white transition-colors duration-200"
              >
                <Mail className="h-4 w-4 text-green-500 flex-shrink-0" aria-hidden="true" />
                <span className="text-sm">sales@dailycreativedesigns.com</span>
              </a>
              <div className="flex items-center gap-3 text-gray-400">
                <MapPin className="h-4 w-4 text-green-500 flex-shrink-0" aria-hidden="true" />
        ...
        <div className="pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-gray-500 text-sm">
            © 2026 Daily Creative Designs. All rights reserved. · Elevating brands since 2012
          </p>
          <nav aria-label="Legal links" className="flex gap-5">
            {LEGAL.map(({ label, href }) => (
              <Link
                key={href}
                to={href}
                className="text-gray-500 hover:text-white text-sm transition-colors duration-200 font-medium"
              >
                {label}
              </Link>
            ))}
