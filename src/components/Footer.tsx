      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-5 gap-8">
          <div className="md:col-span-2">
            ...
            <div className="flex space-x-4">
              ...
              <a href="#" aria-label="Follow us on Instagram" className="text-gray-400 hover:text-white transition-colors">
          ...
          <div>
            ...
            <div className="space-y-3">
              <div className="flex items-center">
                <Phone className="h-5 w-5 text-green-500 mr-3 flex-shrink-0" aria-hidden="true" />
                <a href="tel:+917837319660" className="text-gray-300 hover:text-white transition-colors">+91 78373 19660</a>
              </div>
              <div className="flex items-center">
                <Mail className="h-5 w-5 text-green-500 mr-3 flex-shrink-0" aria-hidden="true" />
              ...
              <div className="flex items-center">
                <MapPin className="h-5 w-5 text-green-500 mr-3 flex-shrink-0" aria-hidden="true" />
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex flex-wrap justify-center gap-x-6 gap-y-2">
            ...
            <Link to="/terms" className="text-gray-400 hover:text-green-500 text-sm transition-colors font-medium">Terms & Conditions</Link>
            <Link to="/cookies-policy" className="text-gray-400 hover:text-green-500 text-sm transition-colors font-medium">Cookies Policy</Link>
            <Link to="/refund-policy" className="text-gray-400 hover:text-green-500 text-sm transition-colors font-medium">Refund Policy</Link>
          </div>
        </div>
      </div>
    </footer>
