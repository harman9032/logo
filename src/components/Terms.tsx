        ...
        <div className="bg-white rounded-2xl shadow-lg p-8 md:p-12">
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-red-900 mb-4">1. Agreement to Terms</h2>
            ...
            {/* 2. Services */}
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-red-900 mb-4">2. Services</h2>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-red-900 mb-4">3. Intellectual Property</h2>
              <p className="text-gray-700 leading-relaxed mb-4">
            ...
            {/* 4. Payment Terms */}
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-red-900 mb-4">4. Payment Terms</h2>
              <p className="text-gray-700 leading-relaxed mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-red-900 mb-4">5. Revisions & Delivery</h2>
              <p className="text-gray-700 leading-relaxed mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-red-900 mb-4">6. Client Responsibilities</h2>
              <p className="text-gray-700 leading-relaxed mb-4">
            ...
            {/* 7. Refund Policy */}
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-red-900 mb-4">7. Refund Policy</h2>
              <p className="text-gray-700 leading-relaxed mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-red-900 mb-4">8. Limitation of Liability</h2>
              <p className="text-gray-700 leading-relaxed mb-4">
            ...
            {/* 9. Confidentiality */}
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-red-900 mb-4">9. Confidentiality</h2>
              <p className="text-gray-700 leading-relaxed mb-4">
            ...
            {/* 10. Termination */}
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-red-900 mb-4">10. Termination</h2>
              <p className="text-gray-700 leading-relaxed mb-4">
            ...
            {/* 11. Governing Law */}
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-red-900 mb-4">11. Governing Law</h2>
              <p className="text-gray-700 leading-relaxed mb-4">
            ...
            {/* 12. Contact */}
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-red-900 mb-4">12. Contact Us</h2>
              <p className="text-gray-700 leading-relaxed mb-4">
