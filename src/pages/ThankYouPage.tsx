        ...
        >
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 md:p-12 mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-8 text-center">
              {content.thankYou.whatNextTitle}
            </h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="text-center">
                ...
                <h3 className="text-xl font-semibold text-gray-900 mb-2">{content.thankYou.step1Title}</h3>
                <p className="text-gray-600">
                  {content.thankYou.step1Description}
                </p>
              </div>
              ...
              <div className="text-center">
                ...
                <h3 className="text-xl font-semibold text-gray-900 mb-2">{content.thankYou.step2Title}</h3>
                <p className="text-gray-600">
                  {content.thankYou.step2Description}
                </p>
              </div>
              ...
              <div className="text-center">
                ...
                <h3 className="text-xl font-semibold text-gray-900 mb-2">{content.thankYou.step3Title}</h3>
                <p className="text-gray-600">
                  {content.thankYou.step3Description}
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-gradient-to-r from-orange-600 to-red-600 rounded-2xl shadow-xl p-8 md:p-12 text-white mb-12">
            <div className="text-center">
              ...
              <h2 className="text-3xl font-bold mb-4">
                {content.thankYou.bonusTitle}
              </h2>
              <p className="text-xl mb-6 text-orange-100">
                {content.thankYou.bonusDescription}
              </p>
              <div className="bg-white/20 rounded-lg p-6 max-w-2xl mx-auto">
                ...
                <div className="text-left space-y-2 text-orange-100">
                  {content.thankYou.bonusItems.split(', ').map((item, index) => (
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 md:p-12 mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-8 text-center">
              {content.thankYou.assistanceTitle}
            </h2>
          ...
          <div className="bg-gray-50 rounded-2xl p-8 md:p-12 mb-12">
            <div className="text-center">
              ...
              <blockquote className="text-xl text-gray-700 mb-6 italic">
                "{content.thankYou.testimonialText}"
              </blockquote>
              <div className="flex items-center justify-center">
                <div className="w-12 h-12 bg-gradient-to-r from-blue-500 to-purple-500 rounded-full flex items-center justify-center text-white font-bold mr-4">
                  {content.thankYou.testimonialName.charAt(0)}
                </div>
                <div className="text-left">
                  <p className="font-semibold text-gray-900">{content.thankYou.testimonialName}</p>
                  <p className="text-gray-600">{content.thankYou.testimonialTitle}</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              >
                {content.thankYou.exploreButtonText}
              </a>
              <a 
                href={BOOKING_LINK}
                target="_blank"
              ...
              >
                {content.thankYou.bookButtonText}
              </a>
            </div>
          </div>
        </EditableSection>
